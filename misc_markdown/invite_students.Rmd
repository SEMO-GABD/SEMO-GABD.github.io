...
6. Fill in the dialog box with the relevant information.
  - Enter `https://github.com/gabd-students/lastname_firstname` for the repository URL, using your last name, an underscore, then your first name.
