...
iris_mod <- iris %>% 
  mutate(box_group = "1",
         point_group = "2",
         outlier_color = ifelse(Sepal.Width < 2.2 | Sepal.Width > 4.0, "maroon", "black"))
...
For this assignment you will use the same dataset used by Zuur et al. (2010) to generate some of their figures. You will then use these techniques to explore another dataset.
