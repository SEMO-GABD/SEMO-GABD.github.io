...
- Both `hw03.Rmd` and `notes03.Rmd` have been modified, indicated by the "M" in the small blue square left of the path.  - `hw03.Rmd` has been staged but not yet commited. 
