...
We will avoid this when we can, but you will at least need it to install _git_ as part of the first assignment. Here is the minimum need-to-know about the **terminal** or **shell**:
