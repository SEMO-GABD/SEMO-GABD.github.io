...
This course, and in fact nearly everything I do in academics, is built from text files. Text files are a base that can be converted into a variety of formats, including web pages, PDF files, and even (gasp!) Word documents. This webpage was generated from [this markdown source file](https://raw.githubusercontent.com/SEMO-GABD/semoClassroom/master/notes/cm001.Rmd) on GitHub.
