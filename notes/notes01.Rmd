...
Git protects your files on your local computer. GitHub provides a cloud-based solution to protect your files, but also allows you to share your code with others, a key part of the open-access philosophy that we have embraced for this course.

You will use Git and GitHub as part of your first two assignments. You will not necessarily understand what you are doing or why. But, once you have done it a couple of times, I think it will then be easier for you to understand the what and why of the process. You will gain that understanding in the third assignment.
...
- They are a (powerfule) way to control your computer.
