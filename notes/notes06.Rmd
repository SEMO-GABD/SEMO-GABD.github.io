...
These notes cover homeworks 6 and 7. For Homework 6, you will focus on data transformation from tibbles, the tidyverse version of data frames. For Homework 7, you will focus on importing, transforming, and wrangling data.
