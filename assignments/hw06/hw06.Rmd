...
- mutate, sumamrize, and group data;
...
- Download this [R Notebook file](https://raw.githubusercontent.com/SEMO-GABD/semo-gabd.github.io/master/assignments/hw06/worksheet_hw06a.Rmd). Right-click to save the file as `<lastname>_hw06a.Rmd` inside the `hw06` folder.
...
- [Download this zip file](https://github.com/SEMO-GABD/semo-gabd.github.io/raw/master/assignments/hw06/data.zip) of data. Unzip the file and place all of the files in your `data` folder. 
